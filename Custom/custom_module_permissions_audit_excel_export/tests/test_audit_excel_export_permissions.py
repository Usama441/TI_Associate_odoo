...
from odoo.addons.custom_module_permissions_audit_excel_export.hooks import post_init_hook
...
class TestAuditExcelExportPermissions(TransactionCase):
    def test_group_and_visibility_bindings(self):
        group = self.env.ref('custom_module_permissions_audit_excel_export.group_custom_module_audit_excel_export')
